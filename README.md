...
| resolveUri                        | An optional URI used to resolve additional metadata for initial tokens by value                                           | ''                                                        |
| resolveUriBuilder                 | A function which is called before sending the resolve request so the URI can be altered/updated                           | (value) -> return this.resolveUri + '?value=' + value     |
